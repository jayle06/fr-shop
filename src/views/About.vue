<template>
  <div>
    <div class="content">
      <img src="@/assets/banner/about.jpg" alt="about image" />
      <div class="text">
        <h3>ADIDAS AT A GLANCE</h3>
